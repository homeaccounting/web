...
/**
 * The published sandbox serves the whole app on its own domain. Left
 * indexable it would compete with the real app for brand searches and put
 * synthetic data in front of people looking for the product, so the demo build
 * ships a noindex (belt) alongside the robots.txt the workflow writes (braces).
 */
