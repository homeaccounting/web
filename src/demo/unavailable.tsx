  ...
  createRoot(container).render(
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <p className="max-w-md text-muted-foreground">
        The sandbox runs entirely inside your browser, which requires a service worker — yours
        blocked it. Private browsing and some extensions do that. Try a normal window, or go
